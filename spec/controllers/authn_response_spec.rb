...
describe AuthnResponseController do
  context 'idp' do
    context 'registration' do
      ...
      include_examples 'idp_authn_response', 'registration', 'PAUSED', 'Paused - REGISTER_WITH_IDP', :paused_registration_path
    ...
    context 'sign_in' do
      ...
      include_examples 'idp_authn_response', 'sign_in', 'PAUSED', 'Paused - SIGN_IN_WITH_IDP', :paused_registration_path
